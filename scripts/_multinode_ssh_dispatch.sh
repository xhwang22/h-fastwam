...
_multinode_dispatch() {
  ...
  for v in RUN_NAME TASK_CONFIG DATA_CONFIG MODEL_CONFIG LAUNCH_LABEL GLOBAL_BATCH_SIZE PER_DEVICE_BATCH_SIZE \
            ...
            USE_ROBOTWIN_DATA_OVERRIDES SET_NUM_SEGMENTS NUM_EPOCHS MAX_STEPS \
            INTERN_A1_ROOT INTERN_A1_MANIFEST_DIR \
            MULTISOURCE_VIDEO_MANIFEST_DIR MULTISOURCE_SAMPLES_PER_EPOCH \
            ...
            TIMESTEP_SAMPLING_PRESET TIMESTEP_SAMPLING_TARGET \
            FASTWAM_ROPE_IMPL \
            ...
            LATENT_ACTION_TRAIN_CACHE_DIR LATENT_ACTION_VAL_CACHE_DIR \
            FFMPEG_PREFIX LD_LIBRARY_PATH \
            USE_VJEPA21_VISUAL_ENCODER VJEPA21_CHECKPOINT VJEPA21_REPO VJEPA21_NORMALISE_STATS_PATH \
            SIGLIP2_MODEL_PATH DINOV3_MODEL_PATH \
            ...
            FRESH RESUME ACTION_DIT_PRETRAINED_PATH FASTWAM_CHECKPOINT \
