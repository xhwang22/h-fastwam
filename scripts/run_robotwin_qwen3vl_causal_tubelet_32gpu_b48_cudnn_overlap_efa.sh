#!/usr/bin/env bash
# 32-GPU Qwen3-VL Flow DiT: per-GPU batch 48, cuDNN SDPA, ZeRO-2 overlap, EFA.
set -euo pipefail
...
export RUN_NAME="${RUN_NAME:-robotwin_qwen3vl_causal_tubelet_32gpu_b48_cudnn_overlap_efa}"
