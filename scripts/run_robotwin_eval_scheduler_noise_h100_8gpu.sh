...
export EVAL_LABEL=vjepa21_scheduler_noise
export MODE="${MODE:-full}"
export NUM_GPUS="${NUM_GPUS:-8}"
export MAX_TASKS_PER_GPU="${MAX_TASKS_PER_GPU:-1}"
export RUN_DIR="${RUN_DIR:-/efs/shaunxhwang/robotwin_vjepa21_video_scheduler_tnoise_shift25_globalnorm_aws_4x8_b48_acc1_gb1536}"
