#!/usr/bin/env bash
# 64-GPU V-JEPA21 full-condition IDM: per-GPU batch 24 = global batch 1536.
set -euo pipefail
...
export RUN_NAME="${RUN_NAME:-robotwin_vjepa21_predictor_idm_full_condition_causal_tubelet_64gpu_b24_cudnn_overlap_efa}"
