...
export INTERN_A1_MANIFEST_DIR="${INTERN_A1_MANIFEST_DIR:-${INTERN_A1_ROOT}/.fastwam_intern_a1/manifest_v1}"
...
export RUN_NAME="${RUN_NAME:-interndata_a1_vjepa21_predictor_pretrain_16gpu_b48_acc2}"
