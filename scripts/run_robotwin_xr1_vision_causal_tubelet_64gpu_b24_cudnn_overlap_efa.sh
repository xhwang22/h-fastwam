#!/usr/bin/env bash
# 64-GPU non-IDM XR-1 vision encoder: per-GPU batch 24, global batch 1536.
set -euo pipefail
...
export RUN_NAME="${RUN_NAME:-robotwin_xr1_vision_causal_tubelet_64gpu_b24_cudnn_overlap_efa}"
